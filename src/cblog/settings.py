...
DATABASES = {
    'default': {
        ...
        'NAME': 'databese1', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'caps-rds.cgrmbgkm7dko.us-east-1.rds.amazonaws.com',  # database endpoint is written her
...
AWS_STORAGE_BUCKET_NAME = 'capstonesuuuublog'
